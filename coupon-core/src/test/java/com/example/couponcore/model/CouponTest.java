...
class CouponTest {
    ...
    @Test
    @DisplayName("쿠폰 수량이 남아있다면 true를 반환한다.")
    public void availableIssueQuantity_1() {
        // given
    ...
    @Test
    @DisplayName("쿠폰 수량이 소진되었다면 false를 반환한다.")
    public void availableIssueQuantity_2() {
        // given
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
                .issuedQuantity(100)
    ...
    public void availableIssueQuantity_3() {
        // given
        Coupon coupon = Coupon.builder()
                .totalQuantity(null)
                .issuedQuantity(100)
    ...
    public void availableIssueDate_1() {
        // given
        Coupon coupon = Coupon.builder()
    ...
    public void availableIssueDate_2() {
        // given
        Coupon coupon = Coupon.builder()
    ...
    @Test
    @DisplayName("발급 기간이 종료 되었다면 false를 반환한다.")
    public void availableIssueDate_3() {
        // given
        Coupon coupon = Coupon.builder()
    ...
    @Test
    @DisplayName("발급 수량을 초과하면 수량 검증 예외를 발생한다.")
    public void issue_2() {
        // given
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
    ...
    @Test
    @DisplayName("발급 기간이 아니면 기간 검증 예외를 발생한다.")
    public void issue_3() {
        // given
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
